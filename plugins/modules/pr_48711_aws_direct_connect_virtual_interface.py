...
DOCUMENTATION = '''
---
module: pr_48711_aws_direct_connect_virtual_interface
...
options:
  ...
  direct_connect_gateway_id:
      description:
        - The direct connect gateway ID mutually exclusive with the virtual_gateway_id for creating a
          private virtual interface. We must specify either a virtual gateway ID or a direct connect gateway ID.
      version_added: "2.8"
...
from ansible.module_utils.ec2 import (AWSRetry, boto3_conn,
...
def create_vi(client, public, associated_id, creation_params):
    ...
    if public:
        ...
        vi = try_except_ClientError(
            failure_msg=err_msg
        )(
            client.create_private_virtual_interface
        )(
            connectionId=associated_id,
